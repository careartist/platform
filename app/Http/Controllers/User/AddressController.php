...
class AddressController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.profile.address.index')->withUser($user);
    }
    ...
    public function create()
    {
        ...
        return view('user.profile.address.create')->withRegions($regions);
    }
    ...
    {
        $user = Sentinel::getUser();
        return view('user.profile.address.edit')->withUser($user);
    }
